...
import com.example.courierapp.helper.*;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAllProducts= (Button)findViewById(R.id.btnAllProducts);
        btnAddLocation= (Button)findViewById(R.id.btnLocation);
        ...
        btnAddLocation.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this,LocationAccess.class));
            }
        });
